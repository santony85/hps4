...
export class HomePage {
  ...
  countNbAction(){
    this.globalservice.getNbAConfirmer().then(data=>{this.naconf=data["data"].length;});
    this.globalservice.getNbRdv().then(data=>{this.nrdv=data["data"].length;});
    this.globalservice.getNbContact().then(data=>{this.ncontact=data["data"].length;});
    this.globalservice.getNbRetard().then(data=>{this.nretard=data["data"].length;});
        ...
        buttons: [
          {
            ...
            handler: (data:string) => {
              ...
              if(data=="3"){
                this.callNumber.callNumber(item.tel, true)
